        ...
        <div class="story-grids">
            <div class="story-grid one">
                <div class="col-md-9 story-grid-text">
                    <p><img src="<c:url value="/static/images/u-qt.png" />" title="" />It was popularised in the 1960s with the release of Letraset sheets containing Lorem
                        Ipsum passages, and more recently with desktop publishing software like Aldus PageMakerincluding versions of Lorem Ipsum. <img src="<c:url value="/static/images/d-qt.png"/>" title="" /></p>
    ...
    <div class="container">
        ...
        <div class="section group">
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop1.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"> <span class="rollover1"> </span></a> </p></div>
            ...
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop2.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"> <span class="rollover1"> </span></a> </p></div>
            ...
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop3.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo">  <span class="rollover1"> </span></a> </p></div>
        ...
        <div class="section group">
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop4.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"> <span class="rollover1"> </span></a> </p></div>
            ...
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop5.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"> <span class="rollover1"> </span></a> </p></div>
            ...
            <div class="col-md-4 gallery-box">
                <div id="nivo-lightbox-demo"> <p> <a href="<c:url value="/static/images/pop6.png" />" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo">  <span class="rollover1"> </span></a> </p></div>
...
<div class="scroll-slider">
    <div class="container">
        <div class="nbs-flexisel-container"><div class="nbs-flexisel-inner"><ul class="flexiselDemo3 nbs-flexisel-ul" style="left: -253.6px; display: block;">
            <li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="<c:url value="/static/images/s1.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="<c:url value="/static/images/s4.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s2.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s3.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s4.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s1.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s2.png" />"></li><li onclick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;">
            <img src="<c:url value="/static/images/s2.png" />"></li></ul><div class="nbs-flexisel-nav-left" style="top: 21.5px;"></div><div class="nbs-flexisel-nav-right" style="top: 21.5px;"></div></div></div>
        <div class="clear"> </div>
        <!--strat-image-cursuals-->
